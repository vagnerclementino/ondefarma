...
import handler from '@/pages/api/pharmacies/neighborhoods';
...
describe('/api/pharmacies/neighborhoods', () => {
  ...
  it('returns list of neighborhoods for BELO HORIZONTE', async () => {
    const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
      method: 'GET',
      query: {
        state: 'MG',
